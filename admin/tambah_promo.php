                    ...
                    <div class="col" style="padding-left: 20%; padding-right: 20%">
                        <div class="card">
                            <div class="card-header" style="text-align: center;">
                                <strong>Tambah Promo Barang</strong>
                            </div>
                            <div class="card-body card-block">
                                <form action="includes/insert/input_promobarang.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="row form-group">
                                    ...
                                    echo "
                                        <div class='col col-md-3'>Nama Produk</div>
                                        <div class='col-12 col-md-9'>
                                        <select onchange='isi_otomatis()' class='form-control' name='kdproduk' id='kdproduk'>
                                        <option value='' disable selected>- Pilih Produk -</option>";

                                        $tampil=mysqli_query($connect, "SELECT * FROM produk ORDER BY namaproduk");
                                        while ($data=mysqli_fetch_array($tampil)){
                                 echo "
                                    <option value=$data[kdproduk]> $data[namaproduk]</option>
                                 ";
                                }
                                echo "
                                  </select>";             
                                  ?>
                                    ...
                                    <div class='row form-group'>
                                        ...
                                        <div class='col-12 col-md-9'><input type='text' readonly id='hargaproduk' name='hargaproduk' placeholder='Harga Produk'  class='form-control'></div>
                                    </div>";
                                    ?>
                                    <div class="row form-group">
