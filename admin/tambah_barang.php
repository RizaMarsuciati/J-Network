                    ...
                    <div class="col" style="padding-left: 20%; padding-right: 20%">
                        <div class="card">
                            <div class="card-header" style="text-align: center;">
                                <strong>Tambah Produk Barang</strong>
                            </div>
                            <div class="card-body card-block">
                                <form action="includes/insert/input_produk.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Nama Barang</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="namaproduk" name="namaproduk" placeholder="Nama Barang . . ." required="required" class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                    <?php
                                ...
                                echo "
                                  ...
                                  ?>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="hargaproduk" name="hargaproduk" placeholder="Harga . . ." required="required" class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="email-input" class=" form-control-label">Keterangan</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="ketproduk" name="ketproduk" placeholder="Keterangan . . ." required="required" class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
